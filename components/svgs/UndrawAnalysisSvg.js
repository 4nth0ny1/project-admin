export default function UndrawAnalysisSvg() {
  return (
    <div className="flex flex-row justify-center">
      ...
      >
        ...
        />
        <path
          d="m276,39.39H2c-1.1,0-2-.9-2-2s.9-2,2-2h274c1.1,0,2,.9,2,2s-.9,2-2,2Z"
          fill="#6c63ff"
        />
        <path
          d="m419.05,122.06H2c-1.1,0-2-.9-2-2s.9-2,2-2h417.05c1.1,0,2,.9,2,2s-.9,2-2,2Z"
          fill="#6c63ff"
        />
        <path
          d="m139,204.72H2c-1.1,0-2-.9-2-2s.9-2,2-2h137c1.1,0,2,.9,2,2s-.9,2-2,2Z"
          fill="#6c63ff"
        />
        <g>
          <polygon
            points="577.06 164.66 560.51 170.3 560.24 146.39 575.31 146.22 577.06 164.66"
            fill="#f3a3a6"
          />
          ...
          <g>
            <path
              id="uuid-c8983f9d-ef50-4d77-8f7b-49f8a94dcf30-33"
          ...
          <rect
            ...
            width="15.56"
            height="22.07"
            transform="translate(-4.9 6.36) rotate(-.64)"
            fill="#f3a3a6"
          />
          <path
          ...
          <rect
            ...
            width="15.56"
            height="22.07"
            transform="translate(-132.35 400.01) rotate(-32.59)"
            fill="#f3a3a6"
          />
          <path
          ...
          />
          <polygon
            points="605.63 248.28 536.44 249.05 556.21 159.38 586.35 159.04 605.63 248.28"
            fill="#6c63ff"
          />
          <path
            id="uuid-97a43cd7-1586-4870-a70d-869ca8f8714f-34"
